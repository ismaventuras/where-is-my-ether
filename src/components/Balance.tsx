...
export function BalancePerChain({ balance }: { balance: Balance }) {
    return (
...
export default function Balance({ address }: { address: string }) {
    ...
    if (isLoading) return (
        <div className="flex justify-center mt-8">
            <div className="">
                <svg aria-hidden="true" className=" w-12 h-12 mr-2 text-gray-200 animate-spin dark:text-gray-600 fill-slate-800 dark:fill-white" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
